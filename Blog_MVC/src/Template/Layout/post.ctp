...
<nav class="top-bar expanded" data-topbar role="navigation">
    ...
    <script src="https://cloud.tinymce.com/5/tinymce.min.js?apiKey=5g5faf78gvk6yfq9bd3bbfjo858kjx1q8o0nbiwtygo2e4er"></script>
  <script>tinymce.init({
                        selector:'textarea',
                        plugins: "image, link, emoticons",
                        toolbar: "undo | redo | formatselect |  bold | italic | underline | strikethrough | alignleft | aligncenter | alignright | alignjustify | forecolor backcolor | link | image | emoticons",
                        height : 500
                    });
  </script>
</body>
